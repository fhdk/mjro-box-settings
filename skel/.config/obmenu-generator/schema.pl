...
our $SCHEMA = [
    ...
    {sep => undef},
    {pipe => ['box-places-pipemenu',        'Places',       'folder']},
    {pipe => ['box-recent-files-pipemenu',  'Recent Files', 'folder-recent']},
    {sep => undef},
    {begin_cat => ['Preferences', 'theme']},
        ...
        {end_cat => undef},
        {pipe => ['box-compositor',     'Compositor',   'compton']},
        {pipe => ['box-conky-pipemenu', 'Conky',        'conky']},
    ...
    {sep => undef},
    {pipe => ['box-kb-pipemenu',            'Display Keybinds',                  'cs-keyboard']},
    {sep => undef},
